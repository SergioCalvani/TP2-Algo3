...
public class InsertarEventMonstruo implements EventHandler<MouseEvent>{
	
	private VistaMonstruo figura;
	private VistaTablero tablero;
	
	public InsertarEventMonstruo(VistaMonstruo unaFigura,VistaTablero unTablero){
	...
	public void handle(MouseEvent event) {
		...
		CambiarEventMonstruo cambio1 = new CambiarEventMonstruo(this.figura,otroEscenario,this.tablero,0);
		primero.setOnAction(cambio1);
		CambiarEventMonstruo cambio2 = new CambiarEventMonstruo(this.figura,otroEscenario,this.tablero,1);
		segundo.setOnAction(cambio2);
		CambiarEventMonstruo cambio3 = new CambiarEventMonstruo(this.figura,otroEscenario,this.tablero,2);
		tercero.setOnAction(cambio3);
		CambiarEventMonstruo cambio4 = new CambiarEventMonstruo(this.figura,otroEscenario,this.tablero,3);
		cuarto.setOnAction(cambio4);
		CambiarEventMonstruo cambio5 = new CambiarEventMonstruo(this.figura,otroEscenario,this.tablero,4);
